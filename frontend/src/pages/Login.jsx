        ...
        <div className="min-h-screen flex items-center justify-center bg-dark text-text-main py-12 px-4">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-text-muted text-sm">Sign in to access your portfolio</p>
                </div>

                {/* Login Card */}
                <div className="bg-card border border-border rounded-2xl p-8 shadow-xl">
                    <h2 className="text-2xl font-bold mb-6 text-text-main">Welcome Back</h2>
                    ...
                    <div className="mt-6 pt-6 border-t border-border text-center">
                        <p className="text-text-muted text-sm">
                            ...
                            <Link to="/register" className="text-secondary hover:text-blue-400 font-semibold transition">
                                Create Account
                            </Link>
                        </p>
                    </div>
